...
inline void SaveJsonValue(rapidjson::Value& v, const int& t, rapidjson::Document::AllocatorType& alloc) {
    v.SetInt(t);
}
...
inline void SaveJsonValue(rapidjson::Value& v, const double& t, rapidjson::Document::AllocatorType& alloc) {
    v.SetDouble(t);
}
